...
| Using wrong Ollama model name             | The docker-compose test stack only pulls `qwen3.5:0.8b`. Use that exact string; `qwen2.5:3b` and other variants are not available in CI.                                                       |
