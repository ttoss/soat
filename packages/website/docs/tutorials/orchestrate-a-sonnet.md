...
The final poem will be persisted in a [document](/docs/modules/documents#examples). A fixed [SOAT tool](/docs/modules/agents#7-soat-tools-platform-actions) will later update that document from the orchestration.
