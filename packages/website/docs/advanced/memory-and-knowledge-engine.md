...
| `query`, `min_similarity`, `rrf_k`, `recency_half_life_days`, `limit`, `memory_ids`, `document_ids`, `document_paths`, `tags` | [`POST /api/v1/knowledge/search`](/docs/api/knowledge/search-knowledge) body | `limit: 10`, `rrf_k: 60`, `recency_half_life_days: 0` | retrieval |
