...
| `extraction`     | `boolean`  | When `true` (requires `write_memory_id`), facts are extracted from each completed turn automatically — see [Automatic Extraction](./memories.md#automatic-extraction) |
