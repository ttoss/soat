...
Obtain a session token by calling `POST /api/v1/users/login`. Obtain a project-scoped API key by calling `POST /api/v1/api-keys`. See [Projects module](/docs/modules/projects) for details.
