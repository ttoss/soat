...
const mcpServer = new McpServer({
  ...
  version,
  description:
    'Open-source infrastructure for production-ready AI agents — backend, identity, storage, memoryStore, and orchestration. LLMs docs: https://soat.ttoss.dev/llms.txt',
